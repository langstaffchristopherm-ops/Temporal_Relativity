% ==============================
% format_macros.tex — PDF figs; single DOI macro; link colors; glossaries+bib
% ==============================

% ---- Release metadata (single source of truth) ----
% release.tex (repo root) should define: \RepoDOI, \RepoCommit, \PaperVersion, \PaperLicense
...
% Single, canonical clickable DOI (TEXT = raw DOI, LINK = doi.org/DOI)
...
\usepackage{float}            % so [H] works reliably
...
% (Removed recursive/duplicate DOI helpers that caused nested \href loops)
